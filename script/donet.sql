...
--사용자 테이블 외래키들
    ALTER TABLE NOTICE ADD CONSTRAINT FK_NOTICE_NO_WRITER FOREIGN KEY (NO_WRITER)REFERENCES MEMBER (USER_ID);
    ALTER TABLE ASK ADD CONSTRAINT FK_ASK_ASK_ID FOREIGN KEY (ASK_ID)REFERENCES MEMBER (USER_ID);
    ALTER TABLE PAYMENT ADD CONSTRAINT FK_PAYMENT_USER_ID FOREIGN KEY (USER_ID)REFERENCES MEMBER (USER_ID);

--결제수단 > 은행 번호 외래키 연결
ALTER TABLE PAYMENT ADD CONSTRAINT FK_PAYMENT_B_NO FOREIGN KEY (B_NO)REFERENCES BANK (BANK_NO);

--FAQ_TYPE 테이블 외래키 연결
ALTER TABLE ASK ADD CONSTRAINT FK_ASK_ASK_TYPENUM FOREIGN KEY (ASK_TYPENUM)REFERENCES FAQ_TYPE (F_TYPENO);

--질문구분 컬럼 외래키
 ALTER TABLE FAQ ADD CONSTRAINT FK_FAQ_F_TYPENUM FOREIGN KEY (F_TYPENUM)REFERENCES FAQ_TYPE (F_TYPENO);
...
CREATE TABLE FUNDIONG_SUPPORTER	(
    ...
    CONSTRAINT FK_FUNDIONG_FG_NO FOREIGN KEY(FG_NO,FP_NO) REFERENCES FUNDIONG_GOODS(FG_NO,FP_NO) ON DELETE CASCADE,
