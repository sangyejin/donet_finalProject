...
VALUES (SEQ_FAQ_TYPE.NEXTVAL,'서비스 이용 및 기타');
 --데이터베이스 가져와서 뿌려주기 -> 카테고리
select * from faq_type;
 
--FAQ 인서트

INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '회원가입은 무료인가요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
'칼이다 청춘의 끓는 피가 아니더면 인간이 얼마나 쓸쓸하랴? 얼음에 싸인 만물은 얼음이 있을 뿐이다 그들에게 생명을 불어 넣는 것은 따뜻한 봄바람이다'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '아이디와 비밀번호가 생각나지 않아요. 어떻게 찾을 수 있나요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '회원 탈퇴를 하고 싶습니다.','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '후원/펀딩 환불이 가능한가요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '어떤 결제 방법을 제공하나요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '현금영수증/세금계산서 발행은 어떻게 하나요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '문의는 어떻게 할 수 있나요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
,'저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '현금영수증 취소를 하고 싶어요.','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
...
INSERT INTO FAQ 
VALUES (SEQ_FAQ.NEXTVAL, '회원 탈퇴 후 재가입이 가능한가요?','저희 도넷닷컴은 기존의 후원 및 펀딩이 접근성이 좋지 않은 방식으로 진행되고 있다는 점에 대해 문제점을 느꼈기에 설립하게 된 5명의 개발자로 이루어진 비영리 단체입니다.'||CHR(10)||CHR(13)|| CHR(10)||CHR(13)|| 
