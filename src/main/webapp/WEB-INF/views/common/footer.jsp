...
#toright, #toleft {float: left; margin-left: 0px; margin-top: 0; position: inline; }
...
#happycustomers { margin-top: 10px; margin-bottom: 5px; }

/*right part*/
#tel { margin-left: -120px; }
		...
		<div id="line"></div>
				<div id="footer">
					...
					<br>
						...
						<h4 id="happycustomers">
							<b>고객 행복 센터</b>
						</h4> <span id="phonenumber">010-3371-5190 </span> <span id="workinghour">(24시
							운영 00:00-24:00)</span> <br>
					<br> <img id="snstap"
						src="${ pageContext.servletContext.contextPath }/resources/imgs/snsbar.png"
						width="335px">
					...
					<div id="toright">
						<div id="listen">
							<span><a>사업자등록번호 : 123-45-6789 </a> | <a>서울 강남 제2000-09호</a>
								| <a>대표자 : 허은주</a></span>
						</div>
						...
						<div id="leftdiv" align="left">
							<span id="tel">Tel : 1544-9970</span> | <span id="fax">Fax :
								02-562-3478</span>
						</div>
						<p id="copyRight">Copyright © 2021 donet.com non-profit company.
